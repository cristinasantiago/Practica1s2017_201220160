...
public class XMLParser extends DefaultHandler {
    ...
    public LSPalabras lsp = VentanaPrincipal.lsp;
    public MTablero mt = Tablero.mt;
    ...
    public void characters(char ch[], int start, int length) throws SAXException {
        ...
        if (bdimension) {
            ...
            Tablero.mt = new MTablero(dimension, dimension);
            bdimension = false;
        }
        ...
        if (bdobles) {
            if (bx) {
                ...
                NodoMT nodo = Tablero.mt.get(tipoX-1, tipoY-1);
                nodo.setTipo(1);
                by = false;
            }
        }
